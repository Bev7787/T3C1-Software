...
int retraceAngle02 = 60;

int RIGHTretraceAngle01 = 120;
int RIGHTretraceAngle02 = 210;
...
void loop() {
  ...
  if (runLeftRetrace == true) {
    ...
    if (millis() - startLeftMillis >= 1700 && leftReleaseFlag == true) {
      leftRetraceRedColour();
  ...
  if (runRightRetrace == true) {
    ...
    if (millis() - startRightMillis >= 1700 && rightReleaseFlag == true) {
      rightRetraceRedColour();
